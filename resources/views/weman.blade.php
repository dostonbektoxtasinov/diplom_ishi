        ...
        <div class="container">
            <div class="row align-items-end mb-4">
                <div class="col-lg-6">
                    ...
                    <h1 class="section-title mb-3">25 - Maktab qiz <br> bolalar</h1>
                </div>
                <div class="col-lg-6">
                    <h4 class="font-weight-normal text-muted mb-3 h1">
                        Yaxshi misol-yaxshi so'zdan <br> yaxshiroqdur
                    </h4>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-5">
                    ...
                    <a class="btn btn-sm btn-primary py-2" href="{{ route('student') }}  ">Read More</a>
                </div>
            </div>
        </div>
    </div>
