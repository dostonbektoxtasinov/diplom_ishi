        ...
        <div class="contact-form">
            ...
            <form action="{{ route('Forma.store') }}"  method="post" enctype="multipart/form-data">
                ...
                <div class="control-group mb-4">
                    ...
                    <input type="text" class="form-control p-4" value=" {{ old('ism') }} " name="ism" placeholder="Nomi" />
                    @error('ism')
                ...
                <div class="control-group">
                    ...
                    <input type="file" class="form-control p-4" name="rasm" value="{{ old('rasm') }}" placeholder="Rasm"/>
